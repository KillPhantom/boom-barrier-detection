...
# if __name__ =='__main__':
	...
	image=cv2.imread('people_night/%d.jpg' %i)
	bot_left = [840, 410]
	bot_right = [940,410]
	apex_right = [940, 0]
	apex_left = [840, 0]
	...
	blur = gaussian_blur(gray, 15)#高斯模糊
	...
	print(i)
	# 下面是判断条件
	if lines is None or min_y>120: #你打开张图看看就知道了 
		
		print('杆未抬起')
		img=cv2.putText(image,'fallen',(40,100),font,2.5,(0,0,255),5) #写字，参数百度
		cv2.imwrite('people_night_result/result%d.jpg' %i,img)
