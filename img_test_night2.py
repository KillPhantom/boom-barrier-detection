...
if __name__ =='__main__':
	...
	image=cv2.imread('night2/259.jpg')
	...
	edge = canny(blur, 20, 80)

	mask = region_of_interest(edge, v)
	lines = cv2.HoughLinesP(mask, 0.8, np.pi/180, 25,minLineLength=35,maxLineGap=6)
...
# 		print(min_y)
# 	if lines is None or min_y<598 or min_y>980:
